...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 flex flex-col overflow-hidden selection:bg-indigo-100 selection:text-indigo-900 overflow-x-hidden w-full relative">

      {/* 0. NAVIGATION */}
      <nav className="w-full max-w-[1400px] mx-auto px-6 py-6 absolute top-0 left-0 right-0 z-50 flex items-center">
        <Link href="/" className="flex items-center gap-3 group">
          <img src="/logo.svg" alt="clearHai Logo" className="h-8 w-8 sm:h-10 sm:w-10 group-hover:scale-105 transition-transform duration-300 object-contain" />
          <span className="font-extrabold text-2xl sm:text-3xl tracking-tight text-slate-800">
            clearHai<span className="text-indigo-600">?</span>
          </span>
        </Link>
      </nav>

      {/* 1. HERO SECTION */}
      <section className="relative w-full max-w-[1400px] mx-auto px-6 pt-32 pb-20 lg:pt-40 lg:pb-32 flex flex-col lg:flex-row items-center justify-between gap-16 z-10">
